from genehearing.preprocess.objects.preprocessing_core import ExcelProcessor
...
def main():
    ...
    tonal_audiometry_processor = ExcelProcessor(tonal_audiometry_datapath, tonal_suffix, genetic_datapath, output_path=config["datarawdirectory"], match_column='PESEL') 
