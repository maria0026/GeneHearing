...
def main():
    ...
    tonal_audiometry_processor = CSVProcessor(tonal_audiometry_datapath, tonal_suffix, genetic_datapath,
                                              abr_datapath,
